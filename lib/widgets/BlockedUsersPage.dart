...
class _BlockedUsersPageState extends State<BlockedUsersPage> {
  // Header height offset – hagaaji haddii HomeHeader-kaagu ka duwan yahay
  static const double kHeaderPad = 190;
  ...
  Widget build(BuildContext context) {
    ...
    // Access denied view with HomeHeader
    if (!isAdmin) {
      return Scaffold(
        body: Stack(
          children: [
                      ...
                      Expanded(
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, i) {
                            ...
                            final ts = (m['blockedAt'] as Timestamp?)?.toDate();
                            ...
                            return Dismissible(
                              ...
                              child: _UserCard(
                                name: name,
                                email: email,
                                role: role.isEmpty ? null : role.toUpperCase(),
