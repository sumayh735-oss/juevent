...
class VenuesManagementDesktop extends StatefulWidget {
  const VenuesManagementDesktop({super.key});

  @override
  State<VenuesManagementDesktop> createState() => _VenuesManagementDesktopState();
}

class _VenuesManagementDesktopState extends State<VenuesManagementDesktop> {
  String searchQuery = '';
